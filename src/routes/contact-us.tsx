	...
	const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
		...
		try {
			const response = await fetch(
				"https://asholascrollbackend.up.railway.app/api/contact",
				{
					method: "POST",
					headers: {
		...
		<div className="container mx-auto py-24 px-4 lg:px-8">
			<div className="flex flex-col lg:flex-row gap-8">
				<div className="flex flex-col gap-9 w-full lg:w-[50%]">
					...
					<p className="text-lg">
						We would love to hear from whether you have questions, need support
						or learn more about us. We are here to help
					</p>
					<div className="flex flex-col lg:flex-row gap-8">
						<div className="flex-1">
							<p className="font-bold">Our Address</p>
							<p>
								Number 20B Peculiar Street, Off Oyebi Street Oriola Bus stop
				...
				<form
					...
					className="bg-secondary-300 p-4 w-full lg:w-[50%] rounded-xl mt-8 lg:mt-0"
				>
					<h2 className="text-center mb-8 mt-4 font-heading text-4xl">
						Get In touch
					</h2>
